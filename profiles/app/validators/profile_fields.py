...
_GENDER_ALIASES = {
    "m": "M", "male": "M", "masculino": "M", "homem": "M",
...
_BLOOD_ALIASES = {
    ...
    "o+": "O+", "o positivo": "O+",
    "o-": "O-", "o negativo": "O-",
    "ab+": "AB+", "ab positivo": "AB+",
    "ab-": "AB-", "ab negativo": "AB-",
}
...
_CIVIL_ALIASES = {
    "single": "single", "solteiro": "single", "solteira": "single",
    "married": "married", "casado": "married", "casada": "married",
    "widowed": "widowed", "viuvo": "widowed", "viúvo": "widowed", "viuva": "widowed", "viúva": "widowed",
    "divorced": "divorced", "divorciado": "divorced", "divorciada": "divorced",
    "stable_union": "stable_union", "uniao_estavel": "stable_union", "união_estável": "stable_union",
    "uniao estavel": "stable_union", "união estavel": "stable_union",
}
