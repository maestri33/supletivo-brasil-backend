"""Coordinators API v1 — CRUD + status management."""
...
from app.schemas import CoordinatorCreate, CoordinatorResponse, CoordinatorUpdate
...
logger = get_logger("coordinator.api.v1.coordinators")
