...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "pix_transaction_id", sa.String(), nullable=True, comment="ID da transacao PIX no Asaas"
        ),
        sa.Column(
            "asaas_transfer_id", sa.String(), nullable=True, comment="ID da transferencia no Asaas"
        ),
        sa.Column(
            "last_error",
            sa.Text(),
    ...
    op.create_table(
        ...
        sa.Column(
            "amount_cents", sa.Integer(), nullable=False, comment="Valor da comissao em centavos"
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_index(
        "ix_commissions_recipient_external_id",
        "commissions",
        ["recipient_external_id"],
        schema=SCHEMA,
    )
    op.create_index(
        "ix_commissions_recipient_role", "commissions", ["recipient_role"], schema=SCHEMA
    )
    op.create_index("ix_commissions_source_type", "commissions", ["source_type"], schema=SCHEMA)
    op.create_index(
        "ix_commissions_source_external_id", "commissions", ["source_external_id"], schema=SCHEMA
    )
    op.create_index("ix_commissions_status", "commissions", ["status"], schema=SCHEMA)
    op.create_index(
        "ix_commissions_payment_batch_id", "commissions", ["payment_batch_id"], schema=SCHEMA
    )
