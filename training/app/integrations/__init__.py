...
Espelha o padrao do `candidate/app/integrations/__init__.py`. Quem fala com outro
servico (ai, roles, notify) herda BaseClient e usa `request_with_retry`.
"""
...
logger = get_logger("training.integrations")
...
class BaseClient:
    """Cliente base — recebe um httpx.AsyncClient ja' configurado (base_url, timeout)."""
