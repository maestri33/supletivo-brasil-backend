"""Schemas da etapa address (persistido no serviço `address`)."""
...
class AddressGetResponse(APIModel):
    message: str = "Preencha seu endereço"
    cep: str | None = None
...
class AddressPostRequest(APIModel):
    cep: str = Field(..., min_length=8, max_length=9, description="CEP com ou sem máscara")
...
class AddressPostResponse(APIModel):
    status: str
    message: str = "Endereço salvo, envie seu RG"
