...
class NotFound(DomainError):
    ...
    def __init__(
        self, detail: str = "Recurso nao encontrado", code: str = "NOT_FOUND"
    ) -> None:
...
class ValidationError(DomainError):
    ...
    def __init__(
        self, detail: str = "Erro de validacao", code: str = "VALIDATION_ERROR"
    ) -> None:
...
class UnauthorizedError(DomainError):
    ...
    def __init__(
        self, detail: str = "Nao autenticado", code: str = "UNAUTHORIZED"
    ) -> None:
...
class ForbiddenError(DomainError):
    ...
    def __init__(
        self, detail: str = "Acesso proibido", code: str = "FORBIDDEN"
    ) -> None:
...
class IntegrationError(DomainError):
    ...
    def __init__(
        self, detail: str = "Erro de integracao", code: str = "INTEGRATION_ERROR"
    ) -> None:
