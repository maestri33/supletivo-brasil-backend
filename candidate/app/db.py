"""Camada de banco — SQLAlchemy async + Base com schema `candidate`.

Sem FK cross-schema: `external_id` eh o UUID do usuario emitido pelo `auth`
(referencia logica, nao enforced por FK — mesma escolha do `asaas`). Isso evita
acoplar o banco do candidate ao schema do auth e simplifica testes.
"""
