...
class TextRequest(BaseModel):
    ...
    instruction: str | None = Field(default=None, description="Refinamento do comportamento (ex: 'Seja tecnico')")
    temperature: float | None = Field(default=None, ge=0.0, le=2.0, description="0=deterministico, 2=max variacao")
